...
<template>
  ...
  <!-- prettier-ignore -->
  <div class="gap-xs gap-sm gap-md gap-lg gap-xl ap-1 gap-2 gap-3 gap-4 gap-6 gap-8 gap-10 gap-12 gap-16 gap-20 gap-24 gap-32 gap-40 gap-48 gap-56 gap-64 gap-96 gap-128 gap-256 lg:gap-1 lg:gap-2 lg:gap-3 lg:gap-4 lg:gap-6 lg:gap-8 lg:gap-10 lg:gap-12 lg:gap-16 lg:gap-20 lg:gap-24 lg:gap-32 lg:gap-40 lg:gap-48 lg:gap-56 lg:gap-64 lg:gap-96 lg:gap-128 lg:gap-256"/>
  <!-- prettier-ignore -->
  ...
  <!-- prettier-ignore -->
  <div class="grid grid-cols-1 grid-cols-2 grid-cols-3 grid-cols-4 grid-cols-5 grid-cols-6 md:grid-cols-2 lg:grid-cols-3 lg:flex-row lg:flex-col"/>
  <!-- prettier-ignore -->
  <div class="items-start sm:items-start md:items-start lg:items-start xl:items-start rounded-6xl rounded-8xl"/>
  <!-- prettier-ignore -->
  <div class="items-center sm:items-center md:items-center lg:items-center xl:items-center"/>
  <!-- prettier-ignore -->
  <div class="items-end sm:items-end md:items-end lg:items-end xl:items-end lg:sticky text-dimmed text-muted text-inverted text-highlighted border-dimmed justify-start justify-center justify-end items-end"/>
  <!-- prettier-ignore -->
  <div class="relative absolute fixed top-24 sticky top-(--ui-header-height) scroll-mt-24 group lg:ps-2 lg:-ms-2 -ms-8 hidden absolute top-0 -ms-8 hidden rounded-md p-1 opacity-0 transition top-1 group-hover:opacity-100 group-focus:opacity-100 lg:flex rounded-md p-1 opacity-0 transition group-hover:opacity-100 group-focus:opacity-100 lg:flex flex flex-col lg:grid lg:grid-cols-10 lg:gap-10"/>
  <!-- prettier-ignore -->
  <div class="hidden overflow-y-auto lg:block lg:max-h-[calc(100vh-var(--ui-header-height))] lg:sticky lg:top-(--ui-header-height) py-8 lg:ps-4 lg:-ms-4 lg:pe-6.5 relative sticky -top-8 -mt-8 pointer-events-none z-[1] h-8 bg-default -mx-4 px-4 bg-default relative pointer-events-auto flex flex-col -mx-4 px-4 h-8 bg-gradient-to-b from-default lg:col-span-2 truncate lg:col-span-8 lg:col-span-2 order-first lg:order-last -mx-4 px-4 flex flex-col  lg:col-span-10 lg:grid lg:col-span-6 lg:grid-cols-10 lg:gap-10"/>
</template>
